...
public class ApkChannel02 {
	...
	private static final String versionName = "1.2.0";
	private static final String appName = "qsl";

	public static void main(String[] args) {
		String apkPath = "F:/渠道打包/"+appName+"_jiami.apk";
		...
		try {
			...
			for(String channel:list) {
				...
				FileOutputStream fos = new FileOutputStream(dfile.getPath()+"/"+appName+"_" + channel + "_"+versionName+".apk");
